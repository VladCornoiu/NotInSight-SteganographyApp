...
public class RestserviceApplicationTests {
    ...
    public void testDecodedData() throws IOException {
        ...
        for (int i = 0; i < 45; ++i) {
            byte[] second = Files.readAllBytes(Paths.get("C:\\Projects\\GitHub\\test_NotInSight\\NotInSight-SteganographyApp\\afterStego\\" + i + "_secret" + ".txt"));
    ...
    public static void deleteTestData() {
        ...
        File stegoFilesDirectory = new File("C:\\Projects\\GitHub\\test_NotInSight\\NotInSight-SteganographyApp\\test");
        ...
        File secretOutputFilesDirectory = new File("C:\\Projects\\GitHub\\test_NotInSight\\NotInSight-SteganographyApp\\afterStego");
